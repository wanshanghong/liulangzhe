    ...
    function ajax(huidiao) {
        ...
        xhr.onreadystatechange = function (ev) {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                var date = new Date(json[0].postDate.year);
                time1.innerHTML = json[0].postDate.year+"/"+json[0].postDate.month+"/"+json[0].postDate.day;
                ...
                for (var j = 0; j < json.length; j++) {
                    ...
                    count.innerHTML = json[j].postDate.day;
                    ...
                    var old_count = li.children[4].children[0].children[0].children[0].innerHTML;
    ...
    function pinglunajax() {
        ...
        xhr.onreadystatechange = function (ev) {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                var userimg = document.createElement("img");
                userimg.src = "images/dog4.jpg";
                li.appendChild(userimg);
                var username = document.createElement("span");
                username.innerHTML = "name2";
                li.appendChild(username);
                var date = new Date();
